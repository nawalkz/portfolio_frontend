      ...
      <div className="grid md:grid-cols-12 grid-cols-1 mt-20">
        ...
        <div className="md:col-span-5 col-span-1">
          ...
          <p className="text-[15px] opacity-[75%] font-light mt-3">
            Feel free to reach out to me for collaborations or freelance
            opportunities.
          </p>
        ...
        <div className="md:col-span-7 col-span-1 flex justify-center items-center">
          <form onSubmit={handleSubmit} className="w-full relative z-[100]">
              ...
              <div className="col-span-1 px-4">
                <div className="mb-[30px]">
                  <input
                    ...
                    required
                    className="w-full p-4 bg-transparent border border-white text-white rounded-[5px] placeholder-gray-400 focus:border-primary focus:outline-none"
                  />
                </div>
              </div>
              ...
              <div className="col-span-2 px-4">
                ...
                <div className="mt-10" ref={scope}>
                  <button
                    ...
                    type="submit"
                    className="w-full relative rounded-full border-2 border-primary px-6 py-2 text-2xl text-primary transition-colors z-[100]"
                  >
                    <span
